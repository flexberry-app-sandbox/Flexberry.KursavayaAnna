...
namespace IIS.KursavayaAnna
{
    ...
    public class Визит : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.KursavayaAnna.Клиент fКлиент;
        
        private IIS.KursavayaAnna.DetailArrayOfЗаписьВизита fЗаписьВизита;
        ...
        [PropertyStorage(new string[] {
                "Клиент"})]
        [NotNull()]
        public virtual IIS.KursavayaAnna.Клиент Клиент
        {
            get
            {
                ...
                IIS.KursavayaAnna.Клиент result = this.fКлиент;
        ...
        public virtual IIS.KursavayaAnna.DetailArrayOfЗаписьВизита ЗаписьВизита
        {
            get
            {
                ...
                {
                    this.fЗаписьВизита = new IIS.KursavayaAnna.DetailArrayOfЗаписьВизита(this);
                }
                IIS.KursavayaAnna.DetailArrayOfЗаписьВизита result = this.fЗаписьВизита;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ВизитE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ВизитE", typeof(IIS.KursavayaAnna.Визит));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ВизитL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ВизитL", typeof(IIS.KursavayaAnna.Визит));
                }
            }
        }
    }
